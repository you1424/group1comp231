...
CREATE TABLE `department` (
  ...
  `departmentsize` int DEFAULT NULL,
...
INSERT INTO `department` VALUES (1,'HR',100.00,30),(2,'Accounting',150.00,40),(3,'IT',200.00,50),(4,'Business',250.00,40);
...
-- Dump completed on 2023-11-18 12:33:07
